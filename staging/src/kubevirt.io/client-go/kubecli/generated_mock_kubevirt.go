// [K8s 1.31兼容] 此 mock 文件针对 K8s 1.34 的 kubernetes.Interface 生成，
// 其方法签名（ResourceV1/CoordinationV1alpha2 等）与 K8s 1.31 不兼容，
// 编译时需跳过。生产代码已拆分到 kubevirt_helpers.go。
//go:build ignore
...
import (
	...
	coordv1alpha1 "k8s.io/client-go/kubernetes/typed/coordination/v1alpha1"
...
func (m *MockKubevirtClient) CoordinationV1alpha1() coordv1alpha1.CoordinationV1alpha1Interface // [K8s 1.31兼容] K8s 1.34 有 CoordinationV1alpha2，1.31 有 V1alpha1 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CoordinationV1alpha1")
	ret0, _ := ret[0].(coordv1alpha1.CoordinationV1alpha1Interface)
	return ret0
}
